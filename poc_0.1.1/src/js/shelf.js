...
export function createShelf(width, height, depth, planes, columns, orientamento){
    ...
    let yPlane = (- height / 2) + 0.8; // il piano viene posizionato alla creazione nel punto 0,0,0 relativo a suo padre(lo scaffale), quindi per portarlo in basso allo scaffale imposto un'altezza pari a - altezzascaffale/2.
